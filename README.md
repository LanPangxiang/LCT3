...
## Additional Notes
We combine the Gowalla dataset provided in Diff-POI with the location category information from STHGCN to determine the specific category of each location. Using this information, we construct trajectory sequences and perform data preprocessing accordingly.
